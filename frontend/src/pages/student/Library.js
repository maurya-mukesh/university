  ...
  return (
    <div className="LibraryPage">
      <div className="alert" hidden={alert}>
        <SuccessAlert alertMsg={"Video Uploaded Successfully"}/>
      </div>
      <div className="container-library m-5 d-flex flex-row">
          ...
          <div className="video-player  d-flex flex-column">
            <div className="col-md-4">
              <iframe
                width="450"
                height="300"
                src={video[0]?.videoLink?video[0]?.videoLink:"https://res.cloudinary.com/bookshelf/video/upload/v1623940094/React_Render_Tutorial_-_1_-_Introduction_ulo4ru.mp4"}
                frameBorder="0"
        ...
        <div className="video-lib border border-3 p-3 mx-3">
