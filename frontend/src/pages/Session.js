...
const Session = () => {
  ...
  const handleCreateSession = (e) => {
    e.preventDefault()
    setAttendanceAlert(false);
    return setAlertMsg("Session Created Successfully..!!");
  };
      ...
      {userType && (
        <div className="">
          <div className="session">
            ...
            <BtnZoomDetail />
            {/* Create Session ====================================================== */}
            {userInfo?.user.role === "instructor" ? <CreateSession alert={handleCreateSession} message={"Session Created Successfully..!!"} /> : ""}
